...
def compute_symmetrised_cross_covariance_eigenvectors(
    ...
    NOTE: This is invariant to scaling of A and B, but not translation (ie: mean-centring, vs baseline, etc).
...
class DirectionAnalyzer:
    ...
    def _analyze_directions(
        ...
        for layer_index in range(start_layer_index, num_layers - skip_end_layers):
            ...
            # Sort the directions into descending order using the variance reduction criterion.
            ...
            if selected_directions > 0:
                ...
                print(f" [{regularised_ratio * 100:.1f}%])")
